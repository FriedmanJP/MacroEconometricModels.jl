...
# =============================================================================
# Fixed oracle DGP (stable model). n=60, k=3, homoskedastic:
...
# MersenneTwister is NOT stable across Julia versions, so the exact (y,x1,x2) the
# external engines saw is committed as data/reg_stab_oracle.csv (generated by
# test/gen_ev_fixtures.jl) and loaded verbatim — reproducible on every Julia.
# =============================================================================
function _stab_oracle_dgp()
    d = readdlm(joinpath(@__DIR__, "data", "reg_stab_oracle.csv"), ',', Float64)
    y = d[:, 1]
